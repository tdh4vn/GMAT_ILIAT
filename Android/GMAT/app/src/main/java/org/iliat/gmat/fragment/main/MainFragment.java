...
public class MainFragment extends BaseFragment {
    ...
    private void connectView(View contentView){
        cardViewSC = (CardView)contentView.findViewById(R.id.card_SC);
        cardViewSC.setOnClickListener(new CardView.OnClickListener() {
            @Override
